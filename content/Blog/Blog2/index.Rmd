...
The author constructed three parameter models by samples to predict the following probabilities: $Pr(L_k=l_k|A_{k-1}=a_{k-1]},L_k=l_k,V=v_o,Y_{k-1}=0)$, $Pr(A_k=a_k|A_{k-1}=a_{k-1]},L_k=l_k,V=v_o,Y_{k-1}=0)$,
